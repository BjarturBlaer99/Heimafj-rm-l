      ...
      <div className={styles.layout}>
        <aside className={styles.aside}>
          ...
          <div data-scroll-reveal="" className={styles.asideContent}>
            ...
            <h2>Meiri yfirsýn.<br /><em>Skýrari ákvarðanir.</em></h2>
            <p className={styles.description}>Hvað kemur inn, hvað fer út og hvað bíður fram undan. Fjármálin þín á einum stað.</p>
            ...
            <Link href="/demo" className={`${styles.demoLink} focus-ring`}>Kynntu þér síðuna með sýnigögnum <span aria-hidden="true">↗</span></Link>
          </div>
